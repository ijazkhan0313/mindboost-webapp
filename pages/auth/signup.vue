<template>
  <div>
    <video-background src="/video/bg-video.mp4" poster="/images/poster.png" style=" height: 100vh;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 col-lg-4 bg-img d-none d-lg-block"
                    ...
                    <div class="col-12">
                      <form method="POST" @submit.prevent="submitRegister">
                        ...
                        <div class="row px-4 pt-3">
                          <div class="col-12">
                            <button :disabled="loading" type="submit" style="min-width:fit-content"
                              class="login-btn fw-bold col-4">
                              {{ t("Signup") }}
                            ...
                            <p class="pt-3">
                              {{ t("Already have an Account?") }} <NuxtLink class="signup-link"
    ...
    submitRegister() {
      ...
      this.$axios.post('/api/register', this.form)
        .then(({ data }) => {
          // console.log()
          this.loading = false
          if (data["message"] === 'The manager has already invited their full quota.') {
